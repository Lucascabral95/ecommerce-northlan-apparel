...
export const EXCHANGE_NAMES = {
  auth: 'auth.exchange',
  cart: 'cart.exchange',
  cartDeadLetter: 'cart.dlx',
  cartRetry: 'cart.retry.exchange',
  catalog: 'catalog.exchange',
  inventory: 'inventory.exchange',
  inventoryDeadLetter: 'inventory.dlx',
  inventoryRetry: 'inventory.retry.exchange',
  notification: 'notification.exchange',
  notificationDeadLetter: 'notification.dlx',
  notificationRetry: 'notification.retry.exchange',
  order: 'order.exchange',
  orderDeadLetter: 'order.dlx',
  orderRetry: 'order.retry.exchange',
  payment: 'payment.exchange',
  paymentDeadLetter: 'payment.dlx',
  paymentRetry: 'payment.retry.exchange',
  user: 'user.exchange',
} as const;
...
export const ROUTING_KEYS = {
  ...
  orderCommandCreateCheckoutSession: 'order.command.create_checkout_session',
  ...
  orderEventOrderConfirmed: 'order.event.order_confirmed',
  orderEventOrderCreated: 'order.event.order_created',
  orderEventOrderStatusChanged: 'order.event.order_status_changed',
  paymentCommandProcessWebhook: 'payment.command.process_webhook',
  paymentCommandRequestPayment: 'payment.command.request_payment',
  paymentCommandSyncPaymentStatus: 'payment.command.sync_payment_status',
  paymentEventPaymentCancelled: 'payment.event.payment_cancelled',
  paymentEventPaymentExpired: 'payment.event.payment_expired',
  paymentEventPaymentFailed: 'payment.event.payment_failed',
  paymentEventPaymentPending: 'payment.event.payment_pending',
  paymentEventPaymentRejected: 'payment.event.payment_rejected',
  paymentEventPaymentSucceeded: 'payment.event.payment_succeeded',
  paymentEventPreferenceCreated: 'payment.event.preference_created',
  paymentEventWebhookProcessed: 'payment.event.webhook_processed',
  paymentEventWebhookReceived: 'payment.event.webhook_received',
...
export const QUEUE_NAMES = {
  ...
  cartDeadLetters: 'cart.commands.dlq',
  cartRetry: 'cart.commands.retry.queue',
  catalogCommands: 'catalog.commands.queue',
  inventoryCommands: 'inventory.commands.queue',
  inventoryDeadLetters: 'inventory.commands.dlq',
  inventoryRetry: 'inventory.commands.retry.queue',
  notificationEvents: 'notification.events.queue',
  notificationDeadLetters: 'notification.events.dlq',
  notificationAuthRetry: 'notification.auth.events.retry.queue',
  notificationOrderRetry: 'notification.order.events.retry.queue',
  notificationPaymentRetry: 'notification.payment.events.retry.queue',
  orderCommands: 'order.commands.queue',
  orderCommandRetry: 'order.commands.retry.queue',
  orderDeadLetters: 'order.messages.dlq',
  orderEvents: 'order.events.queue',
  orderInventoryEvents: 'order.inventory.events.queue',
  orderInventoryEventRetry: 'order.inventory.events.retry.queue',
  orderPaymentEvents: 'order.payment.events.queue',
  orderPaymentEventRetry: 'order.payment.events.retry.queue',
  paymentCommands: 'payment.commands.queue',
  paymentDeadLetters: 'payment.commands.dlq',
  paymentRetry: 'payment.commands.retry.queue',
